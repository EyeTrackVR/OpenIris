...
#ifndef DETAIL_STRING_VIEW_INL
#define DETAIL_STRING_VIEW_INL
...
namespace Helpers {
  ...
  template <typename CharT, typename Traits>
  inline constexpr basic_string_view<CharT,
                                     Traits>::basic_string_view() noexcept
  ...
  basic_string_view<CharT, Traits>::operator[](size_type pos) const noexcept {
    return m_str[pos];
  }
  ...
  basic_string_view<CharT, Traits>::at(size_type pos) const {
    return pos < m_size ? m_str[pos]
                        : throw std::out_of_range(
                              "Input out of range in basic_string_view::at"),
           m_str[pos];
  }
  ...
  template <typename CharT, typename Traits>
  inline void basic_string_view<CharT, Traits>::remove_prefix(
      size_type n) noexcept {
    m_str += n, m_size -= n;
  }

  template <typename CharT, typename Traits>
  inline void basic_string_view<CharT, Traits>::remove_suffix(
      size_type n) noexcept {
    m_size -= n;
  }

  template <typename CharT, typename Traits>
  inline void basic_string_view<CharT, Traits>::swap(
  ...
  template <typename CharT, typename Traits>
  template <class Allocator>
  inline constexpr basic_string_view<CharT, Traits>::operator std::
      basic_string<CharT, Traits, Allocator>() const {
  ...
  basic_string_view<CharT, Traits>::substr(size_type pos, size_type len) const {
  ...
  template <typename CharT, typename Traits>
  inline int basic_string_view<CharT, Traits>::compare(
  ...
  inline int basic_string_view<CharT, Traits>::compare(size_type pos,
                                                       ...
                                                       const char_type* s,
                                                       size_type count2) const {
    return substr(pos, count1)
        .compare(basic_string_view<CharT, Traits>(s, count2));
  }
  ...
  template <typename CharT, typename Traits>
  inline bool basic_string_view<CharT, Traits>::is_one_of(
      CharT c,
